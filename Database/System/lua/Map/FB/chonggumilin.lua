...
function 虫谷密林_执行(地图)
    if 主程.当前时间 > 地图.节点计时 then
        ...
        elseif 地图.副本节点 == 0 then
            if 品质 == 0 then
                地图:地图公告("虫谷密林[白][".. 等级 .."]秘境的封印已解除！ 望各位勇士量力而行，莫要有来无归！")
            elseif 品质 == 1 then
                地图:地图公告("虫谷密林[绿][".. 等级 .."]秘境的封印已解除！ 望各位勇士量力而行，莫要有来无归！")
            elseif 品质 == 2 then
                地图:地图公告("虫谷密林[蓝][".. 等级 .."]秘境的封印已解除！ 望各位勇士量力而行，莫要有来无归！")
            elseif 品质 == 3 then
                地图:地图公告("虫谷密林[紫][".. 等级 .."]秘境的封印已解除！ 望各位勇士量力而行，莫要有来无归！")
            elseif 品质 == 4 then
                地图:地图公告("虫谷密林[橙][".. 等级 .."]秘境的封印已解除！ 望各位勇士量力而行，莫要有来无归！")
            end
            地图.副本节点 = 地图.副本节点 + 1
            地图.节点计时 = 主程.当前时间:AddSeconds(5)
        elseif 地图.副本节点 == 1 then
            地图:地图公告("只有消灭虫谷密林所有的怪物才能在[熄焰恶魔]处领取奖励！")
            地图.副本节点 = 地图.副本节点 + 1
            地图.节点计时 = 主程.当前时间:AddSeconds(5)
        elseif 地图.副本节点 == 2 then
            地图.副本节点 = 地图.副本节点 + 1
            地图.节点计时 = 主程.当前时间:AddSeconds(5)
            地图:地图公告("虫谷密林秘境中的小妖和妖王已经现身,请勇士速速前往击杀！！！")
            local 怪物刷新 = 获取副本怪物区域(地图, "虫谷密林-刷怪区域"):获取刷新范围()
            local 精英刷新 = 获取副本怪物区域(地图, "虫谷密林-刷怪区域"):获取刷新范围()
            local BOSS刷新 = 获取副本怪物区域(地图, "虫谷密林-BOSS区域"):获取刷新范围()
            if 品质 == 0 then
                if 等级 == 40 then
                    范围刷新怪物从地图实例("恶蛆2886", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("蠕虫2888", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("山洞蝙蝠2899", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("杀人蜂2891", 地图, 0, 精英刷新, true, true, true, 10)
                    范围刷新怪物从地图实例("虹魔蝎卫2892", 地图, 0, BOSS刷新, true, true, true, 1)
                elseif 等级 == 45 then
                   范围刷新怪物从地图实例("山洞蝙蝠2899", 地图, 0, 怪物刷新, true, true, true, 25)
                ...
                elseif 等级 == 60 then
                    ...
                    范围刷新怪物从地图实例("骷髅刀斧手2822", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("花吻蜘蛛 幻花2805", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("幻影蜘蛛2806", 地图, 0, BOSS刷新, true, true, true, 3)
                elseif 等级 == 65 then
                    范围刷新怪物从地图实例("骷髅刀斧手2822", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅长枪兵2823", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅弓箭手2824", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("恶蛆2886", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅锤兵2825", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("骨夺2826", 地图, 0, BOSS刷新, true, true, true, 3)
                end
            elseif 品质 == 1 then
                if 等级 == 40 then
                    范围刷新怪物从地图实例("恶蛆2886", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("跳跳蜂幼虫2889", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("山洞蝙蝠2899", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("杀人蜂2891", 地图, 0, 精英刷新, true, true, true, 10)
                    范围刷新怪物从地图实例("虹魔蝎卫2892", 地图, 0, BOSS刷新, true, true, true, 1)
                 elseif 等级 == 45 then
                 ...
                 elseif 等级 == 60 then
                    ...
                    范围刷新怪物从地图实例("匍匐僵尸2821", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("花吻蜘蛛 幻花2805", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("幻影蜘蛛2806", 地图, 0, BOSS刷新, true, true, true, 3)
                 elseif 等级 == 65 then
                    范围刷新怪物从地图实例("匍匐僵尸2821", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("干枯僵尸2828", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("恶灵僵尸2829", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("恶蛆2886", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅锤兵2825", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("骨夺2826", 地图, 0, BOSS刷新, true, true, true, 3)
                 end
            elseif 品质 == 2 then
                if 等级 == 40 then
                    范围刷新怪物从地图实例("恶蛆2886", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("跳跳蜂2890", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("山洞蝙蝠2899", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("杀人蜂2891", 地图, 0, 精英刷新, true, true, true, 10)
                    范围刷新怪物从地图实例("虹魔蝎卫2892", 地图, 0, BOSS刷新, true, true, true, 1)
                elseif 等级 == 45 then
                ...
                elseif 等级 == 65 then
                    范围刷新怪物从地图实例("匍匐僵尸2821", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("干枯僵尸2828", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("恶灵尸王2830", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅锤兵2825", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("骨夺2826", 地图, 0, BOSS刷新, true, true, true, 3)
                end
            elseif 品质 == 3 then
                ...
                elseif 等级 == 65 then
                    ...
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
                    范围刷新怪物从地图实例("骷髅锤兵2825", 地图, 0, 精英刷新, true, true, true, 20)
                    范围刷新怪物从地图实例("堕灵2827", 地图, 0, BOSS刷新, true, true, true, 3)
                end
            elseif 品质 == 4 then
                if 等级 == 40 then
                    范围刷新怪物从地图实例("蜈蚣2887", 地图, 0, 怪物刷新, true, true, true, 25)
        ...
        elseif 地图.副本节点 == 3 then
            local 陷阱刷新 = 获取副本怪物区域(地图, "虫谷密林-陷阱区域"):获取刷新范围()
            if 地图.存活怪物总数 ~= 0 then
                if 主程.当前时间 > 地图.节点计时 then
                ...
                elseif 数字_陷阱刷新间隔 == 0 and 陷阱刷新 ~= nil then
                    if 品质 == 0 then
                        if 等级 == 40 then
                            范围刷新怪物从地图实例(从表随机取值(虫谷密林陷阱刷新怪物表[1]), 地图, 0, 陷阱刷新, true, true)
                        elseif 等级 == 45 then
                            范围刷新怪物从地图实例(从表随机取值(虫谷密林陷阱刷新怪物表[1]), 地图, 0, 陷阱刷新, true, true)
                        elseif 等级 == 50 then
                            范围刷新怪物从地图实例(从表随机取值(虫谷密林陷阱刷新怪物表[1]), 地图, 0, 陷阱刷新, true, true)
        ...
        elseif 地图.副本节点 == 4 and 地图.存活怪物总数 == 0 then
            ...
            for i = 0, 玩家列表.Count - 1 do
                ...
                地图:地图公告("副本中的怪物已经清空！请阁下去[熄焰恶魔]处领取【虫谷密林】副本奖励！")
