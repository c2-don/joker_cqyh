                ...
                elseif 节点 == 1 then
                    if 地图.存活怪物总数 ~= 0 then
                        ...
                        for i = 0, 玩家列表.Count - 1 do
                            ...
                            -- 🆕 添加日程进度：通关标准难度第3层获得30点活跃度
                            if 层数 == 3 and not Settings.屏蔽日程 then
                                if 玩家.角色数据.零点数字[数字_蜘蛛长廊每日领取记录] == 0 then
                                    玩家.角色数据.日程进度.V = 玩家.角色数据.日程进度.V + 30
                                    玩家:发送日程详情()
                                    玩家.角色数据.零点数字[数字_蜘蛛长廊每日领取记录] = 1
                                end
                            end
                        end
                    end
