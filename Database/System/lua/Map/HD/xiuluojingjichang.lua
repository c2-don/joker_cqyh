function 修罗竞技场_执行(地图)
    if 主程.当前时间 > 地图.节点计时 then
        ...
        elseif 地图.地图节点 == 2 then
            if 当前小时 == 20 and 当前分钟 >= 55 or 当前小时 == 20 and 当前分钟 >= 55 then
                地图:地图公告("修罗竞技场活动已经结束！")
                地图.地图节点 = 地图.地图节点 + 1
