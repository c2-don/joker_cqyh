...
package.loaded["Common/zbdyb"] = nil
...
package.loaded["Player/player_wp"] = nil
package.loaded["Player/player_up"] = nil
package.loaded["Player/player_th"] = nil

package.loaded["Monster/monster"] = nil
package.loaded["Monster/monsj"] = nil
...
require "Player/player_wp" --玩家相关交互
require "Player/player_up" --玩家相关交互
require "Player/player_th" --玩家相关交互


require "Monster/monster" --怪物相关交互
require "Monster/monsj" --怪物相关交互
...
-- 主程 = luanet.import_type("游戏服务器.主程")  -- 35行
...
物品使用分类 = luanet.import_type("游戏服务器.物品使用分类")
游戏装备 = luanet.import_type("游戏服务器.模板类.游戏装备")
随机属性 = luanet.import_type("游戏服务器.模板类.随机属性")
铭文技能 = luanet.import_type("游戏服务器.模板类.铭文技能")
游戏货币 = luanet.import_type("游戏服务器.游戏货币")
-- 采集实例 = luanet.import_type("游戏服务器.地图类.采集实例")
游戏装备套装 = luanet.import_type("游戏服务器.游戏装备套装")

系统数据 = luanet.import_type("游戏服务器.数据类.系统数据")
技能数据 = luanet.import_type("游戏服务器.数据类.技能数据")
-- 副本 = luanet.import_type("游戏服务器.副本类.副本")
...
同步角色外形 = luanet.import_type("游戏服务器.网络类.同步角色外形")
武器升级结果 = luanet.import_type("游戏服务器.网络类.武器升级结果")
同步对象容貌 = luanet.import_type("游戏服务器.网络类.同步对象容貌")
角色拖动技能 = luanet.import_type("游戏服务器.网络类.角色拖动技能")
同步技能栏位 = luanet.import_type("游戏服务器.网络类.同步技能栏位")